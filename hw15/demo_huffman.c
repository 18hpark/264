...
int main(int argc, char* argv[]) {
	...
	pq_enqueue(&head, _copy_string("hatt"),   _cmp_strings_by_length);  
	pq_enqueue(&head, _copy_string("har"),   _cmp_strings_by_length);  
	pq_enqueue(&head, _copy_string("hater"),   _cmp_strings_by_length);  
